...
#territorial_waters <- st_read(file.path(prj_path, "data/02_processed/world_territorial_waters.gpkg"))

territorial_waters <- st_read(file.path(prj_path, "data/processed/world_territorial_waters_v2.gpkg"))
...
```{r eval = F}
protected_poly_s1 <- st_read(file.path(prj_path, "data/output/s1_MPAs_single_no_land.shp"))
